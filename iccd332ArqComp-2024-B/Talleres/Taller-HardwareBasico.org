...
** Integrante 2
   ...
   - *Certificado adjunto:*
      #+caption: Certificado Alex Flores
    #+attr_latex: scale=0.30
    #+label: fig:certificado-alex
      [[./images/Certificado_Alex.jpg]]
...
** Integrante 3
   ...
   #+label: fig:certificado-micaela
     [[./images/certificado-micaela.jpg]]

** Integrante 4
   - *Nombre completo:* Jami Tonato Mateo Israel
   - *Correo:* mateo.jami@epn.edu.ec
   - *Certificado adjunto:*     
      #+caption: Certificado Jami Mateo
    #+attr_latex: scale=0.30
    #+label: fig:certificado-mateo
    [[./images/Certificado_Mateo.jpg]]
...
- /Alternativa escogida:/ B
- /Justificación técnica:/ La pulsera antiestática que está conectada
...
- /Debate del grupo:/ En el grupo discutimos y estuvimos de acuerdo en
...
- /Justificación técnica:/ Los LED del panel frontal tienen polaridad,
...
- /Debate del grupo:/ Se descartó la opción A porque no existen
...
- /Alternativa escogida:/ B
- /Justificación técnica:/ La ranura PCle x16 puede suministrar hasta
...
- /Debate del grupo:/ Se descartó la opción A porque la ranura PCle sí
...
** Integrante 4 [Mateo Jami]
   - *¿Qué conocimiento nuevo obtuvo del curso?* En este curso, logré
   ...
   - *¿Qué concepto corrigió o clarificó?* No me quedaba del todo
