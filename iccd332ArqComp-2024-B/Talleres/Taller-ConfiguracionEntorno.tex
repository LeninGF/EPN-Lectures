...
,\#+begin\textsubscript{src} org
\begin{center}
\includegraphics[width=.9\linewidth]{./estudianteD-game.png}
\end{center}
\#+end\textsubscript{src}
\subsection{Usando Emacs para tener Ayuda sobre Emacs}
\label{sec:org71f51b8}
