...
** Variables y tipos
Python permite almacenar valores en variables de diferentes tipos como enteros, flotantes y cadenas. Estos son temas introductorios comunes en hojas de referencia para principiantes.[web:12]
...
** Listas
Las listas permiten agrupar varios valores y recorrerlos. Las hojas de referencia introductorias suelen mostrar creación, acceso, modificación y recorrido de listas.[web:12]
...
La comprensión de listas es una manera concisa de crear listas en Python.[web:15][web:18]
...
En esta segunda parte ya no se explica el concepto paso a paso. Ahora debe crear los bloques de código resolviendo pequeños problemas. Se recomienda usar ~C-c '~ para editar cada bloque y ~C-c C-c~ para probar la solución.[web:6][web:11]
