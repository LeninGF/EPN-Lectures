...
2. En cada seccion ejecute los comandos solicitados y registre la salida en el bloque correspondiente.
4. Guarde el archivo y exporte a pdf con el comando `org-latex-export-to-pdf`. 
...
extraños? Identifique 3 comandos que le sean fáciles y 3 que le
...
**Comandos Fáciles**
1. <Poner el comando>: <Pegar lo que dice el primer párrafo de la ayuda>
2. 
3.
...
- Archivo: ~Taller-ConfiguracionEntorno.org~ completado.
- Archivo: ~Taller-ConfigracionEntorno.pdf~
