...
#+date: 2026-04-08
#+author: MARTÍN PÉREZ
#+email: martin.perez02@epn.edu.ec
#+language: Espanol
#+select_tags: export
...
1. Verificación de entorno mamba/anaconda
   ...
   #+begin_example
	...
	libarchive version : libarchive 3.8.6 zlib/1.3.2 liblzma/5.8.2 bz2lib/1.0.8 liblz4/1.10.0 libzstd/1.5.7 liblzo2/2.10 openssl/3.5.5 libb2/bundled
	  envs directories : /home/martinpr/miniforge3/envs
	     package cache : /home/martinpr/miniforge3/pkgs
			     /home/martinpr/.mamba/pkgs
	       environment : iccd332 (active)
	      env location : /home/martinpr/miniforge3/envs/iccd332
	 user config files : /home/martinpr/.mambarc
    populated config files : /home/martinpr/miniforge3/.condarc
	  ...
	  base environment : /home/martinpr/miniforge3
		  platform : linux-64
   #+end_example
...
|---------------+-----------------------------------------------------------------------------------+---------------------|
|               | Error from syntax checker org-lint: Wrong type argument: number-or-marker-p, "14" |                     |
|               |                                                                                   |                     |
|               |                                                                                   |                     |
...
<Estudiante Santiago Proaño>
#+ATTR_LATEX: :environment longtable :align |p{0.2\linewidth}|p{0.3\linewidth}|p{0.2\linewidth}|p{0.3\linewidth}|
| *Comando*          | *Descripción*                   | *Comando* | *Descripción*                         |
|--------------------+---------------------------------+-----------+---------------------------------------|
| ~C-u 2 C-n~        | El comando permite repetir      | ~C-g~     | Permite cancelar algun comando en     |
|                    | n veces el comando siguiente    |           | ejecución.                            |
|                    | en este caso permite saltar     | ~C-/~     | Permite deshacer el comando previo    |
|                    | una linea 2 veces.              |           | a excepción de comandos de mov. de    |
| ~M-x recover-file~ | Permite recuperar un archivo    |           | cursor.                               |
|                    | del auto guardado.              | ~C-M-v~   | Permite desplazar el siguiente buffer |
| ~M-x repl s~       | Permite remplazar una cadena de |           | abierto sin estar dentro del buffer.  |
|                    | caracteres por otra.            |           |                                       |
...
| *Comando* | *Descripción*                        | *Comando* | *Descripción*                     |
|-----------+--------------------------------------+-----------+-----------------------------------|
| ~C-f~     | Avanzar un carácter en la línea      | ~C-x C-s~ | Guardar los cambios en el archivo |
| ~C-b~     | Retroceder un carácter en la línea   | ~C-x 1~   | Dejar solo una ventana            |
| ~M-a~     | Retroceder al comienzo de la oración | ~C-g~     | Detener un comando no deseado     |
| ~M-e~     | Avanzar al final de la oración       | ~C-s~     | Buscar una palabra                |
...
[[./Emacs_Trainer_Uno_SP.png]]
[[./Emacs_Trainer_Dos_SP.png]]
[[./Emacs_Trainer_Tres_SP.png]]
...
[[./Imágenes/Martin-Cap1.png]]

[[./Imágenes/Martin-Cap2.png]]

[[./Imágenes/Martin-Cap3.png]]
...
**Comandos Fáciles**
1. **Estudiante Santiago Proaño:** ~C-x 3~. C-x 3 runs the command split-window-right (found in global-map), which
...
3. **Martín Pérez:** ~C-x 1~. C-x 1 runs the command delete-other-windows (found in global-map),
which is an interactive native-compiled Lisp function in ‘window.el’.
4. 

**Comandos Difíciles**
1. **Estudiante Santiago Proaño:** ~C-M-v~.C-M-v runs the command scroll-other-window (found in global-map),
which is an interactive native-compiled Lisp function in ‘window.el’. 
2. **Estudiante B:** <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
3. **Martín Pérez:** ~C-x C-b~. C-x C-b runs the command list-buffers (found in global-map), which is
...
| Nombre          | email                        | Rol         |
|-----------------+------------------------------+-------------|
| Santiago Proaño | santiago.proano01@epn.edu.ec | líder       |
| Martín Pérez    | martin.perez02@epn.edu.ec    | colaborador |
| Ariel Montufar  | ariel.montufar@epn.edu.ec    | colaborador |
| Damian Haro     | damian.haro@epn.edu.ec       | colaborador |
|-----------------+------------------------------+-------------|
